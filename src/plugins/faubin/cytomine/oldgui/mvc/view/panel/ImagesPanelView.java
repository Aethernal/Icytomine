...
import plugins.faubin.cytomine.module.main.mvc.frame.IcytomineFrame;
import plugins.faubin.cytomine.oldgui.mvc.controller.panel.ImagesPanelController;
	...
	public ImagesPanelView(long idProj, ImageInstanceCollection instances,
		...
		mnRoi.add(mnGenerate);
				...
				JMenuItem mntmGenerateSectionsFor = new JMenuItem(
						"Sections");
				mnGenerate.add(mntmGenerateSectionsFor);
				
				JMenuItem mntmGlomerules_1 = new JMenuItem("Glomerules");
				mntmGlomerules_1.addActionListener(actionGenerateGlomerule);
				mnGenerate.add(mntmGlomerules_1);
		...
		JMenuItem mntmSection = new JMenuItem("Sections");
		mnDelete.add(mntmSection);
		
		JMenuItem mntmGlomerules = new JMenuItem("Glomerules");
		mnDelete.add(mntmGlomerules);

		JMenuItem mntmDeleteAllAnnotations = new JMenuItem(
				"All");
		mnDelete.add(mntmDeleteAllAnnotations);
