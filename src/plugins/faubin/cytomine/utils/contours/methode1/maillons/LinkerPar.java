...
public class LinkerPar {
	...
	public int[] bruits; /* Tableau pour l'elimination du bruit */
	public int ibruit; /* Seuil pour l'elimination du bruit */
	public Chaine[] fusions; /* Tableau pour la fusion de chaines */
	public int[][][] itab = new int[TX][2][4]; /*
												 * 2 lignes de buffers pour les
												 * traitements de la fsa
												 */
	public int nb_chainons_pile, /*
								 * Taille actuelle de la pile d'allocation des
								 * chainons
								 */
	nb_chaines_pile, /*
					 * Taille actuelle de la pile d'allocation des chaines
					 */
